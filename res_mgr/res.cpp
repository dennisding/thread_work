...
//	};
//
//	using block_info_vector = std::vector<block_info>;
//	
//public:
...
//	{
//		auto name = parse_str();
//		auto new_block = std::make_shared<res>(name);
//
//		block_.reset(name);
//
//		// scan_type
...
//					block_.types_.push_back(type_str);
//					// process_type
//					if (index_ >= bin_->size()) {
//						break;
//					}
//
//					auto token = g_parser_info.char_table_[data[index_]];
//					++index_; // eat the separator
//					if (token == parser_info::TYPE_END) {
//						break;
//					}
//					type_str = parse_str(',', '}');
//				}
